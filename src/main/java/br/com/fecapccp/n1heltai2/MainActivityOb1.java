...
public class MainActivityOb1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_ob1);

        textT2Resultado = findViewById(R.id.textT3Resultado);
        btnT2Reset = findViewById(R.id.btnT3Reset);
